...
${data.message}
        ...
        const mailtoLink = `mailto:charlesmarxist2@gmail.com?subject=${emailSubject}&body=${emailBody}`;
...
document.addEventListener('DOMContentLoaded', function() {
  const username = 'code-with-charles';
  ...
  async function fetchGitHubData() {
    try {
      ...
      // Show fallback data
      document.getElementById('githubRepos').textContent = '115+';
      document.getElementById('githubStars').textContent = '235+';
      document.getElementById('githubFollowers').textContent = '1110+';
      document.getElementById('githubCommits').textContent = '520+';
    }
  }
